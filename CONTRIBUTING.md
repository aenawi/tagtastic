...
- Each release is named with the alphabetically next unused Crayola colour
  from the `crayola_colors` theme in [`data/themes.yaml`](data/themes.yaml)
  (originally sourced from the [Corpora project](https://github.com/dariusk/corpora/blob/master/data/colors/crayola.json)).
